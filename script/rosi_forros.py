...
model1 = load_model(home + '/catkin_ws_forros/src/rosi_defy_forros/script/model.h5') # Replace with your path folder
...
class RosiNodeClass():
	...
	def save_image(self, folder, frame, countImage):
		...
		home = expanduser("~")
		path = home + '/catkin_ws_forros/src/rosi_defy_forros/script'+str('/')+folder # Replace with your path folder
	...
	def save_command_csv(self, countImage, imageName1, imageName2):
		...
		home = expanduser("~")
		path_to_imageName1 = home + '/catkin_ws_forros/src/rosi_defy_forros/script/'+imageName1+'/'   # Replace with your path folder
		path_to_imageName2 = home + '/catkin_ws_forros/src/rosi_defy_forros/script/'+imageName2+'/'   # Replace with your path folder
		path_to_folder = home + '/catkin_ws_forros/src/rosi_defy_forros/script/robotCommands/'        # Replace with your path folder
	...
	def callback_gps(self, msg):
		...
		if self.gpsInc == 20:
			...
			home = expanduser("~")
			#plt.savefig(home + '/catkin_ws_forros/src/rosi_defy_forros/script/map/map.png') # Replace with your path folder
		return None
